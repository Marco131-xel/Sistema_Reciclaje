      ...
      <div className="row g-0">
        ...
        <div className="col-md-6 left-side d-flex flex-column justify-content-center align-items-center p-5">
          <h4 className="mb-3">
            ...
            <i className="bi bi-leaf-fill"></i> Sistema Municipal 3R
          </h4>
          <p className="small mb-4 text-center">
            Plataforma digital para la gestión eficiente de residuos y reciclaje municipal en Guatemala.
          </p>
          <img
        ...
        <div className="col-md-6 p-5 bg-white">
          <div className="text-center mb-4">
            ...
            <p className="text-muted">Inicia sesión para gestionar residuos y reciclaje</p>
          </div>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="btn btn-login w-100 text-white py-2"
            >
              <i className="bi bi-box-arrow-in-right"></i> Entrar
            </button>

            <div className="text-center mt-3">
              <a href="/recuperar" className="custom-link fw-bold">
            ...
            <div className="text-center mt-3">
              <p className="footer-text">
                ¿No tienes cuenta?{" "}
                <a href="/register" className="custom-link fw-bold">
                  Regístrate
                </a>
              </p>
            </div>
